...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return () => {
      ...
      return wrapIf(Transition, hasLayout && (route.meta.layoutTransition ?? defaultLayoutTransition), wrapIf(layouts[layout], hasLayout, context.slots)).default();
    };
  }
});
